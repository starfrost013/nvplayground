...
{
	{ PCI_DEVICE_NV1_NV, PCI_VENDOR_SGS, "NV1 (STG-2000 DRAM version)", nv1_init, NULL, nv1_gpus_section_applies, nv1_gpus_parse_section, },
	...
	{ PCI_DEVICE_NV3, PCI_VENDOR_SGS_NV, "RIVA 128 (NV3), or RIVA 128 ZX without ACPI support (NV3T)", nv3_init, NULL, nv3_gpus_section_applies, nv3_gpus_parse_section, }, 
	{ PCI_DEVICE_NV3T_ACPI, PCI_VENDOR_SGS_NV, "RIVA 128 ZX with ACPI support (NV3T)", nv3_init, NULL, NULL, NULL, },
	{ PCI_DEVICE_NV4, PCI_VENDOR_NV, "RIVA TNT (NV4)", nv4_init, nv4_shutdown, NULL, NULL, },
