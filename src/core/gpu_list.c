...
{
	{ PCI_DEVICE_NV1_NV, PCI_VENDOR_SGS, "NV1 (STG-2000 DRAM version)", nv1_init, NULL, NULL, NULL, NULL, },
	...
	{ PCI_DEVICE_NV4, PCI_VENDOR_NV, "RIVA TNT (NV4)", NULL, NULL, NULL, NULL, NULL, },
