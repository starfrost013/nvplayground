...
bool NV3_Init()
{
    ...
    __dpmi_set_segment_limit(current_device.bus_info.bar0_selector, NV_MMIO_SIZE - 1);
    ...
    __dpmi_set_segment_limit(current_device.bus_info.bar1_selector, NV_MMIO_SIZE - 1); // ultimately the same size
