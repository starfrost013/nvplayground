...
bool Alpine_Init()
{
    ...
    */
    if (!bar0_base)
    {
        ...
        PCI_WriteConfig32(current_device.bus_number, current_device.function_number, PCI_CFG_OFFSET_BAR0, CIRRUS_MMIO_SPACE_TEST);
    ...
    __dpmi_set_segment_limit(current_device.bar0_selector, meminfo_bar0.size);
